...
namespace VirusTotal
{
    public partial class VirusTotal
    {
        ...
        public VirusTotal(string apiKey)
        {
            ...
            _apiKey = apiKey;
            Client.BaseUrl = new Uri("http://www.virustotal.com/vtapi/v2/");
        ...
        public bool UseTLS
        {
            ...
            {
                _useTls = value;
                Client.BaseUrl = new Uri(value ? Client.BaseUrl.ToString().Replace("http://", "https://") : Client.BaseUrl.ToString().Replace("https://", "http://"));
            }
        }
